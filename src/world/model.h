...
namespace cg::world {
    ...
    protected:
        ...
        static void fill_vertex_data(cg::vertex &vertex, const tinyobj::attrib_t &attrib, tinyobj::index_t idx,
                                     float3 computed_normal, tinyobj::material_t material);

        void fill_buffers(const std::vector<tinyobj::shape_t> &shapes, const tinyobj::attrib_t &attrib,
